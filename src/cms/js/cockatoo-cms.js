;(function($) {
    ...
    $.extend($.CockatooList, {
      ...
      up : function (){
				...
				if ( instance.root.find('div.list > div[index="'+instance.cursor+'"] > a:hidden').length ){
					this.up();
				}
      },
      down : function (){
...
//		ndata[p] = { dc : ((d==='-')?'P ':'') + m[1] , c : clazz , i : d , p : p , u: m[1] };
  ...
  function shortcut(){
    ...
    node.find('tbody').append('<tr><th>Shortcut</th><th>Effect</th></tr>')
      .append('<tr><th>Ctrl-[SPACE]</th><td>Select current list element</td></tr>')
      ...
      .append('<tr><th>Ctrl-[LEFT]</th><td>Move LIST FORCUS to next</td></tr>')
      .append('<tr><th>Ctrl-[RIGHT]</th><td>Move LIST FORCUS to prev</td></tr>')
      .append('<tr><th>Ctrl-a</th><td>Add element</td></tr>')
      .append('<tr><th>Ctrl-u</th><td>Update element</td></tr>');
