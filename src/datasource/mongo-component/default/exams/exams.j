...
"id":"exams",
"class":"page",
"body":"<div class=\"mongo\">\r\n<div class=\"window\" style=\"width:100%;clear:both;\">\r\n<div class=\"hd1\">\r\n<div class=\"h2\">\r\n  <h2>\u554f\u984c<\/h2>\r\n<\/div>\r\n<div class=\"hd2\">\r\n  <?cs each: item = A.mongo.exams?>\r\n<div class=\"<?cs if:!item.public ?>private<?cs \/if?>\">\r\n<dt><a href=\"\/mongo\/exams\/<?cs var:item.docid ?>\"><?cs var:item.qname?> \uff1a\uff08\u5168<?cs var:item.qnum ?>\u554f\uff09<\/a> (by <?cs var:item._ownername ?> <time><?cs var:item._timestr ?><\/time>) <\/dt><dd><?cs if:S.login.exam[item.docid].score ?><div class=\"prevscore\">\u524d\u56de\u30b9\u30b3\u30a2\uff1a <?cs var:S.login.exam[item.docid].score ?>\u70b9<\/div><?cs \/if ?>\r\n<?cs var:item.qsummary ?><\/dd>\r\n<\/div>\r\n  <?cs \/each ?>\r\n<\/div>\r\n<\/div>\r\n<\/div>\r\n<\/div>\r\n<?cs if:S.login.writable?>\r\n  <div class=\"edit\"><a href=\"\/mongo\/exams\/edit\/new\">\u65b0\u898f\u554f\u984c<\/a><\/div>\r\n<?cs \/if ?>",
"action":[
