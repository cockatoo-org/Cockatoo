	...
	drawEntry: function(entry){
	  ...
	  var receiveM  = this.calcMargin(entry.timings.receive);
	    $('<tr class="row">'+
	      ...
	      '  </div>'+
	      ' </td>'+
	      ' <td class="col status"><div class="status '+(entry.cache.afterRequest?'cached':'')+'"><span>'+entry.response.status+' '+entry.response.statusText+'</span></div></td>'+
	      ...
	      '      <td><div class="base">+' + entry.timings.dns + 'ms</span></td>'+
	      ...
	      '      <td><div class="base">+' + (entry.timings.dns+entry.timings.connect)+ 'ms</span></td>'+
	      ...
	      '      <td><div class="base">+' + (entry.timings.dns+entry.timings.connect+entry.timings.send)+ 'ms</span></td>'+
	      ...
	      '      <td><div class="base">+' + (entry.timings.dns+entry.timings.connect+entry.timings.send+entry.timings.wait)+ 'ms</span></td>'+
